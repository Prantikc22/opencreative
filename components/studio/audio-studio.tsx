...
const voices = [
  ...
  {
    id: "Pulcherrima",
    sample: "/audio/zuri.wav",
    name: "Zuri",
    language: "English · Swahili",
    style: "Energetic, magnetic",
    use: "Social",
    accent: "East African",
    color: "#a25c48",
  },
  {
    id: "Umbriel",
    sample: "/audio/ana.wav",
    name: "Ana",
    language: "Portuguese · English",
    style: "Natural, optimistic",
    use: "Lifestyle",
    accent: "Brazilian",
    color: "#638562",
  },
  {
    id: "Zephyr",
    sample: "/audio/eli.wav",
    name: "Eli",
    language: "English",
    style: "Youthful, breezy",
    use: "Conversational",
    accent: "American",
    color: "#5b85a2",
  },
