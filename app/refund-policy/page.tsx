...
export default function RefundPolicyPage() {
  return <main className="legal-page"><nav><Link href="/"><ArrowLeft size={15} />OpenCreative</Link></nav><header><p className="eyebrow">Refund policy</p><h1>Clear before checkout.</h1><p>This policy explains renewals, cancellation and refund requests for hosted OpenCreative plans.</p><small>Effective September 11, 2026 · Last updated September 11, 2026</small></header><section className="legal-copy">
    ...
    <h2>How to request help</h2><p>Contact <a href={`mailto:${productConfig.supportEmail}`}>{productConfig.supportEmail}</a> with the account email and transaction details, or use the secure support and customer-portal links in your Dodo Payments receipt. Dodo Payments, our merchant of record, processes approved returns to the original payment method. Refunded credits and paid access may be removed when the refund is completed.</p>
  </section></main>;
}
