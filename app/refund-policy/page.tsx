...
export default function RefundPolicyPage() {
  return <main className="legal-page"><nav><Link href="/"><ArrowLeft size={15} />OpenCreative</Link></nav><header><p className="eyebrow">Refund policy</p><h1>Clear before checkout.</h1><p>This policy explains renewals, cancellation and refund requests for hosted OpenCreative plans.</p><small>Effective September 7, 2026 · Last updated September 7, 2026</small></header><section className="legal-copy">
    ...
    <h2>Refund requests</h2><p>We offer a 30-day money-back guarantee on a customer&apos;s first subscription purchase when the service has not been materially consumed or abused. Renewal payments, usage overages, one-time credit bundles and consumed generation or agent usage are generally non-refundable except where required by law. Nothing in this policy limits mandatory consumer cancellation or refund rights.</p>
    ...
    <h2>How to request help</h2><p>Contact <a href={`mailto:${productConfig.supportEmail}`}>{productConfig.supportEmail}</a> with the account email and transaction details, use the link in your Paddle receipt, or visit <a href="https://paddle.net" target="_blank" rel="noreferrer">paddle.net</a>. Paddle, our merchant of record, processes approved returns to the original payment method. Refunded credits and paid access may be removed when the refund is completed.</p>
  </section></main>;
}
